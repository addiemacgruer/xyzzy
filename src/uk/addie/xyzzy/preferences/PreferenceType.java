...
public enum PreferenceType {
  BOOLEAN {
    @Override Object getValue(final Activity activity, final String setting,
    ...
    @Override void setValue(final Activity activity, final String setting, final Object value) {
