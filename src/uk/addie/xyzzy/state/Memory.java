...
public class Memory implements Serializable {
  ...
  public final ZStack<CallStack> callStack = new ZStack<CallStack>(null);
  ...
  private static final ZStream streams = new ZStream();
  ...
  public static void setScreenColumns() {
    ...
    final int columns = Math.min(numberOfZeroes, 0xff); // some games will complain if they're less
                                                        // than 80 columns, but it has to fit in a
                                                        // byte
    final int rows = 24;
